...
ProtectedProductDetailView, ProtectedProductCreateView, ProtectedProductUpdateView, ProtectedProductDeleteView, ProtectedListView)
...
urlpatterns = [
    ...
    path("my-products/", ProtectedListView.as_view(template_name="my_products.html")),
]